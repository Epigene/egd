# rspec spec/egd/builder_spec.rb
RSpec.describe Egd::Builder do
  describe "#to_h" do
  ...
  describe "#to_json" do
    ...
    context "when initialized with 00 PGN" do
      ...
      it "produces the readme JSON" do
        expect(json).to eq(
          "{\"game_tags\":{\"Result\":\"*\"},\"moves\":{\"1w\":{\"start_position\":"\
    ...
    context "when initialized with 02 PGN, the real deal" do
      ...
      it "JSON-ifies the built hash" do
        expect(json).to match(
          %r'\A{\"game_tags\":{\"Result\":\"0-1\",\"Event\":\"Eurotel Trophy.*6\",\"features\":{}}}}}\z'
        )
      end
    end
  end
